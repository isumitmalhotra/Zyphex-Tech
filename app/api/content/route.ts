...
export async function GET(request: NextRequest) {
  try {
    ...
    if (page) {
      ...
      return NextResponse.json({
        ...
        sections: pageSections.map(section => ({
          ...
          layoutSettings: section.layoutSettings ? JSON.parse(section.layoutSettings as string) : {},
          contentData: section.contentData ? JSON.parse(section.contentData as string) : {},
    ...
    if (contentType) {
      const contentTypeRecord = await prisma.contentType.findFirst({
